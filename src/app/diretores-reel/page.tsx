...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Diretores Reel | Sobremesa Ideias",
    description:
      "Uma seleção de reels dos diretores da Sobremesa Ideias.",
    url: absoluteUrl("/diretores-reel"),
    type: "website",
  },
};
...
export default async function DiretoresReelPage() {
